...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/storage/assets/styles/contact.css">
    <link rel="stylesheet" type="text/css" href="/storage/assets/styles/contact_responsive.css">
    ...
    .invalid-feedback{ color: rgba(224, 0, 3, 1.00)}
    .error {
        position: fixed;
        top: 50%;
        left: 50%;
